...
### Data loading
```{r}
# reading excel file (see supplementary Data 4 in a paper "Special food of long-lived kings and queens in termites")
d <- read_excel("Supplementary Data 4.xlsx", sheet="Sheet1")
